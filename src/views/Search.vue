<template>
    <div class="paddingTop search_page">
        <top-header goBack="true" headTitle="搜索"></top-header>
...
export default {
    ...
    mounted(){
        ...
        if (getLocal('searchHistory')){
            this.searchHistory = JSON.parse(getLocal('searchHistory'));
        }
    },
    methods:{
        async searchTarget(historyValue){
            ...
            this.restaurantList = (await searchRestaurant(this.geohash, this.searchValue)).data;
            this.emptyResult = !this.restaurantList.length;
            let history = getLocal('searchHistory');
            if (history) { 
            ...
            setLocal('searchHistory', this.searchHistory);
        },
        checkInput(){
            if (this.searchValue === '') {
