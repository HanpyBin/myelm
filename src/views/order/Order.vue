            ...
            <li class="order_list_li" v-for="item in orderList" :key="item.id">
                ...
                <section class="order_item_right">
                    ...
                    <div class="order_again">
                        ...
                        <router-link :to="{path: '/shop', query: {geohash, id: item.restaurant_id}}" tag="span" class="buy_again">再来一单</router-link>
                    </div>
                </section>
            </li>
        </ul>
    ...
    methods:{
        ...
        async initData(){
            if (this.userInfo && this.userInfo.user_id){
                let res = (await getOrderList(this.userInfo.user_id, this.offset)).data;
                this.orderList = [...res];
                this.hideLoading();
            } else {
                this.hideLoading();
