<template>
  <div class="rating_page">
    <top-header head-title="账户信息" go-back="true"></top-header>
    <section class="profile-info">
      ...
      <section class="headportrait headportraitwo headportraitthree">
        <h2>收货地址</h2>
        <div class="headportrait-div">
          <span class="headportrait-div-bottom">
            <svg fill="#d8d8d8">
      ...
      <section class="info-router" @click="changePhone">
        <section class="headportrait headaportraitwo headportraithree">
          <h2>
            <img
...
import {removeLocal} from '@/config/mUtils';
