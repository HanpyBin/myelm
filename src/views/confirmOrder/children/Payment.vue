<template>
    <div class="common_page">
        <top-header headTitle="在线支付" goBack="true"></top-header>
...
export default {
    ...
    methods:{
        ...
        async initData(){
            this.payDetail = (await payRequest(this.orderMessage.order_id, this.userInfo.user_id)).data;
