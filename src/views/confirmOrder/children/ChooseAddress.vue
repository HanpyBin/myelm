<template>
    <div class="common_page">
        <top-header headTitle="选择地址" goBack="true"></top-header>
    ...
    methods:{
        ...
        async initData(){
            ...
            if (this.userInfo && this.userInfo.user_id) {
                this.addressList = (await getAddressList(this.userInfo.user_id)).data;
                ...
                console.log(this.deliverdisable);
            }
        },
        iconColor(name){
            switch(name){
